...
export const FirstSection = () => {
    ...
    return (
        <section className="magicpattern min-h-screen flex flex-col bg-slate-900 overflow-hidden">
            <Header />
            ...
            <div className="relative flex flex-col items-center justify-center text-center px-6 py-16 md:py-20 lg:py-28">
                ...
                >
                    ...
                    <span
                        className={`
                            ...
                            ${isLoaded ? 'text-purple-300' : 'text-white'}
                        `}
                        style={{
                ...
                >
                    ...
                    <strong className="text-purple-300"> React, Laravel with experience in UX/UI Design</strong>, based in Morocco. Passionate about
