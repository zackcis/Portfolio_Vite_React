...
export const PinContainer = ({
  ...
  return (
    <div
      className={`my-6 group/pin relative z-50 cursor-pointer ${containerClassName}`}
    ...
    >
      ...
      >
        <div
          ...
          className="absolute  left-1/2 top-1/2 flex items-start justify-start overflow-hidden rounded-2xl   shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 group-hover/pin:border-white/[0.2] "
        >
...
export const PinPerspective = ({ title, href }) => {
  return (
    <motion.div className="z-[60]  my-9 lg:my-4 flex h-80 w-full items-center justify-center opacity-0 transition duration-500 group-hover/pin:opacity-100">
